...
@Autonomous(name = "ExpBlueThreeRows", group = "Autonomous")
@Configurable // Panels
public class ExperimentBlueThreeRows extends OpMode {
    ...
    public static class Paths {
        ...
        public PathChain ShootToRow3;

        public PathChain BackToShootFinal2;
        ...
        public Paths(Follower follower) {
            ...
            ShootToIntake = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(52.500, 70.5), new Pose(8, 68.5))
                    )
            ...
            IntakeBackToShoot = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(8, 68.5), new Pose(59.500, 84.500))
                    )
            ...
            ShootToRow2 = follower
                    ...
                    .setLinearHeadingInterpolation(Math.toRadians(135), Math.toRadians(180))
                    .addPath(
                            new BezierLine(new Pose(55.5, 70.5 - 36), new Pose(8, 70.5-34))
                    )
                    .setConstantHeadingInterpolation(Math.toRadians(180))
                    .build();
            ...
            ShootToRow3 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(59.500, 84.5), new Pose(55.5, 70.5 - 70))

                    )
                    .setLinearHeadingInterpolation(Math.toRadians(135), Math.toRadians(180))
                    .addPath(
                            new BezierLine(new Pose(55.5, 70.5 - 70), new Pose(8, 70.5-70))
                    )
                    .setConstantHeadingInterpolation(Math.toRadians(180))
                    .build();

            BackToShootFinal2 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(
                                    new Pose(8, 70.5-70),
        ...
        switch (pathState) {
            ...
            case 9:
                ...
                case 11:
                    ...
                    case 12:
                        // Shoot within 4 seconds
                        //Begin Path to last row intake
                        shootAndThenIntake(shootRPM, 21);
                        ...
                        if(getStateTime() > 3) {
                            intake.setPower(0.8);
                            follower.setMaxPower(0.9);
                            follower.followPath(paths.ShootToRow3);
                            nextState();
                        }
            ...
            case 14:
                ...
                intake.setPower(0);
                follower.setMaxPower(1);
                follower.followPath(paths.BackToShootFinal2);
                nextState();
                break;
